...
func (m *Plugin) generatePerSchema(data *codegen.Data) error {
	...
	for filename, file := range files {
		...
		file.imports = append(file.imports, rewrite.Import{ImportPath: "car/presenters/graph_admin/genresolvers"})
		file.imports = append(file.imports, rewrite.Import{ImportPath: "car/resolvers"})
