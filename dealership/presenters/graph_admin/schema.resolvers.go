...
import (
	...
	"dealership/presenters/graph_admin/generated"
	"dealership/presenters/graph_admin/genresolvers"
)

//THIS IS A TEMPLATE FOR EDIT

func (r *dealershipResolver) Cars(ctx context.Context, obj *ent.Dealership) ([]*models_admin.Car, error) {
