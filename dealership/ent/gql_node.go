...
var carsImplementors = []string{"Cars", "Node"}

// IsNode implements the Node interface check for GQLGen.
func (*Cars) IsNode() {}

var dealershipImplementors = []string{"Dealership", "Node"}

// IsNode implements the Node interface check for GQLGen.
func (*Dealership) IsNode() {}
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case cars.Table:
		query := c.Cars.Query().
			Where(cars.ID(id))
		query, err := query.CollectFields(ctx, carsImplementors...)
		if err != nil {
			return nil, err
		}
		...
		return n, nil
	case dealership.Table:
		query := c.Dealership.Query().
			Where(dealership.ID(id))
		query, err := query.CollectFields(ctx, dealershipImplementors...)
		if err != nil {
			return nil, err
		}
		n, err := query.Only(ctx)
