...
import (
	...
	"dealership/presenters/graph_admin"
	middleware2 "dealership/presenters/middleware"
	"dealership/resolvers"
	"dealership/streams"
...
func main() {
	...
	logrus.Info("Starting dealership service for: admin API")
