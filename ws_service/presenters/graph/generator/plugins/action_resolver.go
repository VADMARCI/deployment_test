...
func (m *Plugin) generatePerSchema(data *codegen.Data) error {
	...
	for filename, file := range files {
		...
		file.imports = append(file.imports, rewrite.Import{ImportPath: "ws_service/presenters/graph/genresolvers"})
		file.imports = append(file.imports, rewrite.Import{ImportPath: "ws_service/resolvers"})
